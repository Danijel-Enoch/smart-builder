...
const NFT_WASM_CODE: &[u8] = include_bytes!("./templates/builds/non_fungible_token.wasm");
const DEX_WASM_CODE: &[u8] = include_bytes!("./templates/builds/ref_exchange_141.wasm");
const DEX_FARM_WASM_CODE: &[u8] = include_bytes!("./templates/builds/ref_farming_v0104.wasm");
const FT_WASM_CODE: &[u8] = include_bytes!("./templates/builds/fungible_token.wasm");
